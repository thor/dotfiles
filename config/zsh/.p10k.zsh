# Generated by Powerlevel10k configuration wizard on 2019-12-15 at 23:49 GMT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_GIT_HOOKS=(vcs-detect-changes git-untracked git-aheadbehind git-remotebranch)
